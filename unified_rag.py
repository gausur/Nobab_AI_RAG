...
Cyber + Medical + Physics + Dark Web — ALL IN ONE
"""
...
DOMAINS = {
    ...
    "darkweb": {
        ...
        "keywords": ["dark web", "Tor", "onion", "I2P", "cryptocurrency", "ransomware leak"]
    },
    # raw collection (universal ingester থেকে আসা)
    "raw_cyber": {
        "collection": "raw_cyber_knowledge",
        "dataset_dir": "datasets/raw_cyber",
        "keywords": ["CVE", "exploit", "malware", "attack", "phishing", "ransomware"]
    },
    "raw_medical": {
        "collection": "raw_medical_knowledge",
        "dataset_dir": "datasets/raw_medical",
        "keywords": ["gene", "protein", "disease", "cancer", "genomics"]
    },
    "raw_quantum": {
        "collection": "raw_quantum_knowledge",
        "dataset_dir": "datasets/raw_quantum",
